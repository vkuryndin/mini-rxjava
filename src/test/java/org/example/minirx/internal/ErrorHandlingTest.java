 ...
 *
 * <ul>
 *   <li>that an error terminates the stream,
 *   <li>that signals after an error are ignored,
 *   <li>that a null error is replaced with a {@link NullPointerException}.
 * </ul>
 */
class ErrorHandlingTest {

  /**
   * Verifies that after an error is emitted, the stream is terminated and later signals are
   * ignored.
   */
  @Test
  ...
  /** Verifies that calling onError with null is converted into a {@link NullPointerException}. */
  @Test
  ...
  /** Verifies that a normal stream still completes successfully when no error occurs. */
  @Test
